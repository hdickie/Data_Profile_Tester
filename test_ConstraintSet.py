...
class TestConstraintSet(TestCase):
    ...
    def test_check_absolute_dimension_cross_product_constraint(self):
        # todo add more
        pass

    def test_check_relative_dimension_cross_product_constraint(self):
        # todo add more
        pass

    def test_check_mutually_exclusive_constraint(self):
        # todo add more
        pass
